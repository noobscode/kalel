...
def intro():
    print('\n')
    print(green + 'Hash Buster is a python script which uses several\nonline hash crackers to find cleartext of a hash in less than 5 seconds.\n')
    print(info + ' Inspired by Team Ultimate' + end)
    print(info + ' Github: https://github.com/UltimateHackers\n' + end)
    print(que + 'Supports the following hashes: MD5 | SHA1 | SHA2\n' + end)
...
def crack(hashvalue):
    if len(hashvalue) == 32:
        ...
        print("%s This hash is not supported.\n") % bad
        raw_input(green + 'Press [ENTER] to go back to the menu!' + end)
